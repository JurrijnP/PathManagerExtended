...
using UnityEngine;
using UIUtils = PathManagerExtended.UI.UIUtils;

namespace PathManagerExtended.Util
{
    public static class Settings
    {
        public static string SettingsFile => $"{nameof(PathManagerExtended)}";
        ...
        public static void OnSettingsUI(UIHelperBase helper)
        {
            ...
            generalTab.AddGroup(PathManagerExtended.StaticFullName);
